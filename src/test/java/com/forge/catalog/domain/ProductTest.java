...
class ProductTest {
        ...
        void shouldRejectInvalidConstructionAndUpdates() {
                ...
                Money price = Money.of("10", Currency.USD);

                assertThrows(IllegalArgumentException.class,
                                () -> new Product(null, "Laptop", "", price, ProductStatus.ACTIVE));
                assertThrows(IllegalArgumentException.class,
                                () -> new Product(sku, " ", "", price, ProductStatus.ACTIVE));
                assertThrows(IllegalArgumentException.class,
                                () -> new Product(sku, "Laptop", "", null, ProductStatus.ACTIVE));
                assertThrows(IllegalArgumentException.class,
                                () -> new Product(sku, "Laptop", "", price, null));

                Product product = new Product(sku, "Laptop", "", price, ProductStatus.ACTIVE);
                assertThrows(IllegalArgumentException.class,
                                () -> product.updateDetails(null, "description", price));
                assertThrows(IllegalArgumentException.class,
